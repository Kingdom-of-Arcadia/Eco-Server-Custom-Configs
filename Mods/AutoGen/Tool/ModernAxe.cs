namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernAxeItem : AxeItem
    {
        ...
        private static SkillModifiedValue caloriesBurn = CreateCalorieValue(10, typeof(LoggingEfficiencySkill), typeof(ModernAxeItem), new ModernAxeItem().UILink());
        public override IDynamicValue CaloriesBurn { get { return caloriesBurn; } }
        private static SkillModifiedValue damage = CreateDamageValue(2.5f, typeof(LoggingDamageSkill), typeof(ModernAxeItem), new ModernAxeItem().UILink());
