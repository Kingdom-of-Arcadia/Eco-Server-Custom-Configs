namespace Eco.Mods.TechTree
{
    ...
    public partial class WoodenHoeRecipe : Recipe
    {
        public WoodenHoeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(WoodenHoeRecipe), Item.Get<WoodenHoeItem>().UILink(), 0.5f, typeof(BasicCraftingSpeedSkill));
    ...
    public partial class WoodenHoeItem : HoeItem
    {
        ...
        private static SkillModifiedValue caloriesBurn = CreateCalorieValue(20, typeof(HoeEfficiencySkill), typeof(WoodenHoeItem), new WoodenHoeItem().UILink());
