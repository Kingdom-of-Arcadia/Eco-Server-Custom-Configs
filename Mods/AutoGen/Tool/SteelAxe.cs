namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelAxeItem : AxeItem
    {
        ...
        private static SkillModifiedValue caloriesBurn = CreateCalorieValue(15, typeof(LoggingEfficiencySkill), typeof(SteelAxeItem), new SteelAxeItem().UILink());
        public override IDynamicValue CaloriesBurn { get { return caloriesBurn; } }
        private static SkillModifiedValue damage = CreateDamageValue(2, typeof(LoggingDamageSkill), typeof(SteelAxeItem), new SteelAxeItem().UILink());
