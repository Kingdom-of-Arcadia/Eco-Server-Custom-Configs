...
public class BowItem : ToolItem
{
    ...
    private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(10, BasicCraftingSkill.MultiplicativeStrategy, typeof(BasicCraftingSkill), Localizer.Do("repair cost"));
    public override IDynamicValue SkilledRepairCost { get { return skilledRepairCost; } }

    public override IDynamicValue CaloriesBurn { get { return caloriesBurn; } }
    public override string FriendlyName { get { return "Bow"; } }
    public override string Description { get { return Localizer.Do("Shoots arrows.  Useful for hunting."); } }
...
public class ArrowEntity : NetEntity
{
    ...
    public void Hit(NetObjAttachInfo hitAttachInfo, Vector3 position)
    {
        ...
        if (this.Controller is Player && PropertyManager.IsAuthorized((this.Controller as Player).User, position.Round, other as IInteractable, "damage that").Notify(this.Controller as Player))
        {
