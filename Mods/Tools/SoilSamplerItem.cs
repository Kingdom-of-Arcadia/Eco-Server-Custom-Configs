...
namespace Eco.Mods.TechTree
{
    ...
    public class SoilSamplerItem : ToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(1, BasicCraftingSkill.MultiplicativeStrategy, typeof(BasicCraftingSkill), Localizer.Do("repair cost"));
