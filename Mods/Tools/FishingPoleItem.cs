...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FishingPoleItem : ToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(10, FishingSkill.MultiplicativeStrategy, typeof(FishingSkill), Localizer.Do("repair cost"));
